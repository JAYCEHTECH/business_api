...
def send_and_save_to_history(user_id, txn_type: str, txn_status: str, paid_at: str, ishare_balance: float,
    ...
    return ishare_response, ishare_response.status_code
                ...
                if enough_balance:
                    ...
                    if channel.lower() == "wallet":
                        ...
                        if new_user_wallet == previous_user_wallet:
                            ...
                            print("it's fine")
                    ishare_response, status_code = send_and_save_to_history(user_id, txn_type, txn_status,
                                                                                        paid_at,
                    ...
                    print(status_code)
                    if status_code == 400:
                        return Response(data={'status_code': status_code, "message": "Authorization Failed"},
                                        status=status.HTTP_400_BAD_REQUEST)
